...
object TestDbSchemaConst {

    const val first_table = "first_table"
    const val second_table = "second_table"
    const val third_table = "third_table"
    ...
    const val alias_a = "alias_a"
    const val alias_b = "alias_b"
